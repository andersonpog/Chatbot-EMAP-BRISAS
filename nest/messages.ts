...
0 - Encerrar atendimento`,
    ...
    3 - Reagendar/Cancelar visita`,
     ...
     //SE A PESSOA QUISER AGENDAR:
        AGENDAR_VISITA_PORTO: `Agradecemos o interesse pela EMAP - Porto do Itaqui! ⚓️

        📅 Agendamento de Visitas: É feito diretamente pelo nosso site: https://www.portodoitaqui.com/porto-do-itaqui/agende-uma-visita
    ...
    4- Jovem Aprendiz`,
        ...
        TRABALHE_CONOSCO:`Primeiramente, gostaríamos de agradecer o seu contato e o interesse pela EMAP-Porto do Itaqui!
        ...
        A fim de atender a sua manifestação, informamos que, no caso de estágio na EMAP, os interessados devem se cadastrar no site do IEL - Instituto Euvaldo Lodi: http://sne.iel.org.br/ma. Quando surgem vagas, o recrutamento é feito por essa instituição, contratada pela EMAP como agente de integração.
...
// Quando a pessoa clicar em Oferta comercial.
    RESPOSTA_COMERCIAL: `Agradecemos o interesse na EMAP. Por sermos uma empresa pública, nossas contratações ocorrem exclusivamente via licitação. Veja como acompanhar e participar:

    📊 Editais: Acompanhe no nosso site (https://www.portodoitaqui.com/transparencia/licitacoes) e no programa PDF/FIEMA.
    💻 Sistema: Nossos pregões ocorrem no portal Licitações-e do Banco do Brasil. É necessário se cadastrar lá: https://www.licitacoes-e.com.br/
